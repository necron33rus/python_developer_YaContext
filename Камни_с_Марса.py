...
def stones_from_mars(ordered_weights, delivered_weights):
    ...
    for weight in delivered_weights:
        ...
        while j < len(ordered_weights):
            if ordered_weights[j] <= weight:
                count += 1
                del ordered_weights[j]
                break
            j += 1
...
n = int(input())
ordered_weights = list(map(int, input().split()))
m = int(input())
delivered_weights = list(map(int, input().split()))

result = stones_from_mars(ordered_weights, delivered_weights)
print(result)
